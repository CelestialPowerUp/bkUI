    ...
    var elements = [
        ...
        {id:"download", header:"下载", width:60, template:function(obj){
            if(obj.attachment_id && obj.attachment_view && obj.attachment_view.raw_url){
                return "<a class='status status1 webix_icon download' href='"+obj.attachment_view.raw_url+"' target='_blank'>下载</a>"
            }
            return "";
        }},
        {id:"edit", header:"&nbsp;", width:80, template:"<span class='trash webix_icon fa-pencil' title='编辑'>编辑</span>"}
    ];
