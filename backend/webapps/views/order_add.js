define(["models/order",
    ...
    "views/webix/baidumap"], function (order, product, base, order_product, user_car_model, order_details, order_supplier) {
    ...
    var parse_supplier_info = function (supplier) {
        $$("adaption_supplier_info").setHTML((supplier.supplier_mold === 'community' ? "社区店" : (supplier.supplier_mold === 'self_support' ? "自营店" : "综合店")) + " " + supplier.supplier_name);
        ...
        elements: [
            ...
            //服务商
            {
                view: "toolbar", css: "highlighted_header header5", height: 40, elements: [
                    ...
                    {
                        view: "button", id: "add_supplier_button", label: "选择服务商", width: 105,
                        click: adaption_supplier
                    }
                ]
            },
            {
                cols: [
                    {
                        ...
                        columns: [
                            ...
                            {id: "address", editor: "text", header: "地址", fillspace: true},
            ...
            //服务方式
            {
                ...
                // {
                //     view: "segmented",
                //     id: "switch_service_type",
                //     value: "",
                //     tooltip: "sasjdkjkdjasakjsda",
                //     inputWidth: 250,
                //     options: [
            ...
            //优惠券
            {
                ...
                {view: "text", id: "coupon_code", width: 120, placeholder: "输入优惠券码"}, {
                    view: "button", label: "兑换", width: 50, click: function () {
    ...
    var getOrderAddress = function () {
        ...
        return {
            latitude: $$("longitude").getValue(),
            longitude: $$("latitude").getValue(),
            name: "",
            address: $$("take_car_address").getValue()
        };
    }
